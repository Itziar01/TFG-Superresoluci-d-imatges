...
srresnet_checkpoint = "/home/msiau/workspace/ibeltran/111/SRGAN/models/checkpoint_srresnet_sat_rgbn.pth.tar"  # filepath of the trained SRResNet checkpoint used for initialization
best_loss = float('inf')
...
save_checkpoint_name = '/home/msiau/workspace/ibeltran/111/SRGAN/models/'
checkpoint_min_name = '/home/msiau/workspace/ibeltran/111/SRGAN/models/min_srgan_rgbn.pth.tar'
batch_size = 16  # batch size
start_epoch = 0  # start at this epoch
iterations = 2e4  # number of training iterations
...
def main():
    ...
    Training.
    """
    global start_epoch, epoch, checkpoint, srresnet_checkpoint, best_loss

    # Initialize model or load checkpoint
    if checkpoint is None:
        # Generator
        generator = Generator(n_features=4,
        ...
        # Discriminator
        discriminator = Discriminator(n_features=4,
    ...
    truncated_vgg19 = TruncatedVGG19(i=vgg19_i, j=vgg19_j, input_channels=4)
    ...
    for epoch in range(start_epoch, epochs):
        ...
        # Save checkpoint
            torch.save({'epoch': epoch,
                        ...
                        'optimizer_g': optimizer_g,
                        'optimizer_d': optimizer_d},
                        save_checkpoint_name + "la_definitiva/checkpoint_" + str(epoch) + ".pth.tar")
...
def train(train_loader, generator, discriminator, truncated_vgg19, content_loss_criterion, adversarial_loss_criterion,
    ...
    @optimizer_g (Adam) optimizer for the generator
    ...
    if best_loss > losses_a.avg:
        best_loss = losses_a.avg
        torch.save({'epoch': epoch,
            'generator': generator,
            'discriminator': discriminator,
            'optimizer_g': optimizer_g,
    ...
    writer.add_scalar("Training/Loss_Generator", losses_a.avg, epoch)
    writer.add_scalar("Training/Loss_Discriminator", losses_d.avg, epoch)
    writer.add_scalar("Training/Content_loss", losses_c.avg, epoch)
